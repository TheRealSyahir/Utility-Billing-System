...
public class SEditPriceScreen extends JPanel{
	...
	public SEditPriceScreen(MainFrame main, int ind, meterPrice pri) {
		...
		textField.setText(Double.valueOf(pri.getWPrice()).toString());
		
		textField_1 = new JTextField();
		textField_1.setBounds(195, 143, 146, 26);
		add(textField_1);
		textField_1.setColumns(10);
		textField_1.setText(Double.valueOf(pri.getGPrice()).toString());
		
		textField_2 = new JTextField();
		textField_2.setBounds(195, 187, 146, 26);
		add(textField_2);
		textField_2.setColumns(10);
		textField_2.setText(Double.valueOf(pri.getEPrice()).toString());
